...
def insert_collections_data(follow_lst, MAX_RETRIES):
    attempts = 0
    ...
    while attempts < MAX_RETRIES:
        ...
        try:
            with connection.cursor() as cursor:
                insert_query = "INSERT INTO COLLECTIONS (USERNAME, COLLECTIONNAME) VALUES (%s, %s)"
...
def main():
    ...
    # The pairs in follows come from ChatGPT and gives users made up collections
    ...
    insert_collections_data(follow_lst, MAX_RETRIES)
